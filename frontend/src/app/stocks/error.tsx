    ...
    return (
        <div className="min-h-screen bg-[#050510] text-gray-200">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                ...
                <div className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-violet-500/5 blur-[120px]"></div>
            </div>
            ...
            <div className="relative z-10 px-6 py-8 max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-gray-400 mb-6">
                        We couldn&apos;t fetch the latest stock information. This might be a temporary issue with our data provider.
                    </p>
