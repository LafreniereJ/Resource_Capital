    ...
    return (
        <div className="min-h-screen bg-[#050510] text-gray-200">
            ...
            <div className="relative z-10 px-6 py-8 max-w-7xl mx-auto">
                {/* Header */}
                <Link href="/" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-cyan-400 mb-8 transition">
                    ← Dashboard
                </Link>
                ...
                >
                    ...
                    <p className="text-gray-400 mb-6">
                        We couldn&apos;t fetch the latest mining news. Our RSS feeds might be temporarily unavailable.
                    </p>
